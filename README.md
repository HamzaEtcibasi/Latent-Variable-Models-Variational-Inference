...
<br/><br/>
# Acknowledgements
We followed the slides by Stefano Ermon and Aditya Grover and benefited from the lecture notes of [Dr. Gökberk Cinbiş](https://user.ceng.metu.edu.tr/~gcinbis/) when preparing this topic summary. For more information, visit [Deep Generative Models](https://deepgenerativemodels.github.io/).
